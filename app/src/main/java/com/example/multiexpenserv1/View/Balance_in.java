...
import com.example.multiexpenserv1.Success;
        ...
        Save.setOnClickListener(v -> {
            ...
            if(isMinusOperationDone && isAddOperationDone){
                ...
                if (!(title.isEmpty() || amount.isEmpty() || day.isEmpty() || month.isEmpty() || year.isEmpty())) {
                    ...
                    //Doing Minus operation
                        ...
                        if (Amount_String.isEmpty()) {
                            ...
                            if(Balance_Integer>=amount_t) {
                                ...
                                Toast.makeText(Balance_in.this, "Insufficient Balance !", Toast.LENGTH_LONG).show();
                    ...
                    if(isAddOperationDone) obj.setStatus("Deposit");
                    else if(isMinusOperationDone) obj.setStatus("Withdraw");
